preproc = function(data){
  data[,`:=`(# variables at below added on 24 July
             # bureau
             Add_DIFF_SUM_DEBT_CREDIT_BUREAU = AMT_CREDIT_SUM_DEBT_SUM - AMT_CREDIT_SUM_SUM,
             Add_DIFF_SUM_DEBT_LIMIT_BUREAU = AMT_CREDIT_SUM_DEBT_SUM - AMT_CREDIT_SUM_LIMIT_SUM,# RATIO generate Inf/-Inf when AMT_CREDIT_SUM_DEBT_SUM = 0
             Add_RATIO_SUM_PAYMENT_BUREAU =  AMT_ANNUITY_SUM / AMT_CREDIT_SUM_SUM, 
             Add_DIFF_MEAN_DEBT_CREDIT_BUREAU = AMT_CREDIT_SUM_DEBT_MEAN - AMT_CREDIT_SUM_MEAN,
             Add_DIFF_MEAN_DEBT_LIMIT_BUREAU = AMT_CREDIT_SUM_DEBT_MEAN - AMT_CREDIT_SUM_LIMIT_MEAN,
             Add_RATIO_MEAN_PAYMENT_BUREAU =  AMT_ANNUITY_MEAN / AMT_CREDIT_SUM_MEAN,
             # POS_CASH
